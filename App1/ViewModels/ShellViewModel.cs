...
using App1.Core.ApiHelper.SearchHelper;
...
namespace App1.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        private AutoSuggestBoxSuggestionChosenEventArgs _suggestionChosen;
        private List<LocationItem> _suggestions;
        private string _text;
        private ICommand _loadedCommand;
        private ICommand _itemInvokedCommand;
        private ICommand _querysubmittedCommand;
        private ICommand _texthaschangedCommand;
        ...
        public AutoSuggestBoxSuggestionChosenEventArgs SuggestionChosen
        {
            get { return _suggestionChosen; }
            set { Set(ref _suggestionChosen , value); }
        }
        public List<LocationItem> Suggestions
        {
